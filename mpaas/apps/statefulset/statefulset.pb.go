...
type Base struct {
	...
	VolumeClaimTemplates *pvc.CreatePVCRequest `protobuf:"bytes,7,opt,name=VolumeClaimTemplates,proto3" json:"volumeClaimTemplates" bson:"volumeClaimTemplates"`
}
...
var file_apps_statefulset_pb_statefulset_proto_rawDesc = []byte{
	...
	0x61, 0x69, 0x6d, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x18, 0x07, 0x20, 0x01,
