...
var file_apps_namespace_pb_rpc_proto_goTypes = []interface{}{
	(*QueryNamespaceRequest)(nil), // 0: codehorse.mpaas.namespace.QueryNamespaceRequest
	(*NamespaceSet)(nil),          // 1: codehorse.mpaas.namespace.NamespaceSet
}
var file_apps_namespace_pb_rpc_proto_depIdxs = []int32{
	0, // 0: codehorse.mpaas.namespace.RPC.QueryNamespace:input_type -> codehorse.mpaas.namespace.QueryNamespaceRequest
	1, // 1: codehorse.mpaas.namespace.RPC.QueryNamespace:output_type -> codehorse.mpaas.namespace.NamespaceSet
