...
var file_apps_job_pb_rpc_proto_goTypes = []interface{}{
	(*DeleteJobRequest)(nil),   // 0: codehorse.mpaas.job.DeleteJobRequest
	(*UpdateJobRequest)(nil),   // 1: codehorse.mpaas.job.UpdateJobRequest
	(*QueryJobRequest)(nil),    // 2: codehorse.mpaas.job.QueryJobRequest
	(*DescribeJobRequest)(nil), // 3: codehorse.mpaas.job.DescribeJobRequest
	(*CreateJobRequest)(nil),   // 4: codehorse.mpaas.job.CreateJobRequest
	(*Job)(nil),                // 5: codehorse.mpaas.job.Job
	(*JobSet)(nil),             // 6: codehorse.mpaas.job.JobSet
}
var file_apps_job_pb_rpc_proto_depIdxs = []int32{
	4, // 0: codehorse.mpaas.job.UpdateJobRequest.Job:type_name -> codehorse.mpaas.job.CreateJobRequest
	4, // 1: codehorse.mpaas.job.RPC.CreateJob:input_type -> codehorse.mpaas.job.CreateJobRequest
	0, // 2: codehorse.mpaas.job.RPC.DeleteJob:input_type -> codehorse.mpaas.job.DeleteJobRequest
	1, // 3: codehorse.mpaas.job.RPC.UpdateJob:input_type -> codehorse.mpaas.job.UpdateJobRequest
	2, // 4: codehorse.mpaas.job.RPC.QueryJob:input_type -> codehorse.mpaas.job.QueryJobRequest
	3, // 5: codehorse.mpaas.job.RPC.DescribeJob:input_type -> codehorse.mpaas.job.DescribeJobRequest
	5, // 6: codehorse.mpaas.job.RPC.CreateJob:output_type -> codehorse.mpaas.job.Job
	4, // 7: codehorse.mpaas.job.RPC.DeleteJob:output_type -> codehorse.mpaas.job.CreateJobRequest
	5, // 8: codehorse.mpaas.job.RPC.UpdateJob:output_type -> codehorse.mpaas.job.Job
	6, // 9: codehorse.mpaas.job.RPC.QueryJob:output_type -> codehorse.mpaas.job.JobSet
	4, // 10: codehorse.mpaas.job.RPC.DescribeJob:output_type -> codehorse.mpaas.job.CreateJobRequest
