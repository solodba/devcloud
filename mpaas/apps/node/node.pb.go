...
type NodeSetItem struct {
	...
	Age string `protobuf:"bytes,3,opt,name=Age,proto3" json:"age" bson:"age"`
...
func (x *NodeSetItem) GetAge() string {
	if x != nil {
		return x.Age
	}
	return ""
...
var file_apps_node_pb_node_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x03, 0x41, 0x67, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x49, 0x6e, 0x74, 0x65, 0x72,
