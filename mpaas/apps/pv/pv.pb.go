...
type PVSetItem struct {
	...
	Age string `protobuf:"bytes,9,opt,name=Age,proto3" json:"age" bson:"age"`
...
func (x *PVSetItem) GetAge() string {
	if x != nil {
		return x.Age
	}
	return ""
...
var file_apps_pv_pb_pv_proto_rawDesc = []byte{
	...
	0x2e, 0x6d, 0x70, 0x61, 0x61, 0x73, 0x2e, 0x70, 0x76, 0x1a, 0x35, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	...
	0x6f, 0x72, 0x73, 0x65, 0x2e, 0x6d, 0x70, 0x61, 0x61, 0x73, 0x2e, 0x70, 0x76, 0x2e, 0x4c, 0x69,
	...
	0x65, 0x2e, 0x6d, 0x70, 0x61, 0x61, 0x73, 0x2e, 0x70, 0x76, 0x2e, 0x4e, 0x66, 0x73, 0x56, 0x6f,
	...
	0x2e, 0x6d, 0x70, 0x61, 0x61, 0x73, 0x2e, 0x70, 0x76, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x6d, 0x70, 0x61, 0x61, 0x73, 0x2e, 0x70, 0x76, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x4d, 0x61, 0x70,
	...
	0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x41, 0x67, 0x65, 0x12, 0x16, 0x0a, 0x06,
	...
	0x6f, 0x75, 0x64, 0x2f, 0x6d, 0x70, 0x61, 0x61, 0x73, 0x2f, 0x61, 0x70, 0x70, 0x73, 0x2f, 0x70,
...
var file_apps_pv_pb_pv_proto_goTypes = []interface{}{
	(*CreatePVRequest)(nil), // 0: codehorse.mpaas.pv.CreatePVRequest
	(*NfsVolumeSource)(nil), // 1: codehorse.mpaas.pv.NfsVolumeSource
	(*VolumeSource)(nil),    // 2: codehorse.mpaas.pv.VolumeSource
	(*ListMapItem)(nil),     // 3: codehorse.mpaas.pv.ListMapItem
	(*PV)(nil),              // 4: codehorse.mpaas.pv.PV
	(*PVSet)(nil),           // 5: codehorse.mpaas.pv.PVSet
	(*PVSetItem)(nil),       // 6: codehorse.mpaas.pv.PVSetItem
	(*meta.Meta)(nil),       // 7: codehorse.mcube.meta.Meta
}
var file_apps_pv_pb_pv_proto_depIdxs = []int32{
	3, // 0: codehorse.mpaas.pv.CreatePVRequest.Labels:type_name -> codehorse.mpaas.pv.ListMapItem
	2, // 1: codehorse.mpaas.pv.CreatePVRequest.VolumeSource:type_name -> codehorse.mpaas.pv.VolumeSource
	1, // 2: codehorse.mpaas.pv.VolumeSource.NfsVolumeSource:type_name -> codehorse.mpaas.pv.NfsVolumeSource
	7, // 3: codehorse.mpaas.pv.PV.Meta:type_name -> codehorse.mcube.meta.Meta
	0, // 4: codehorse.mpaas.pv.PV.PV:type_name -> codehorse.mpaas.pv.CreatePVRequest
	6, // 5: codehorse.mpaas.pv.PVSet.Items:type_name -> codehorse.mpaas.pv.PVSetItem
	3, // 6: codehorse.mpaas.pv.PVSetItem.Labels:type_name -> codehorse.mpaas.pv.ListMapItem
