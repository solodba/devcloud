...
var file_apps_cronjob_pb_cronjob_proto_goTypes = []interface{}{
	(*CreateCronJobRequest)(nil), // 0: codehorse.mpaas.cronjob.CreateCronJobRequest
	(*JobBase)(nil),              // 1: codehorse.mpaas.cronjob.JobBase
	(*CronJobBase)(nil),          // 2: codehorse.mpaas.cronjob.CronJobBase
	(*ListMapItem)(nil),          // 3: codehorse.mpaas.cronjob.ListMapItem
	(*CronJob)(nil),              // 4: codehorse.mpaas.cronjob.CronJob
	(*CronJobSetItem)(nil),       // 5: codehorse.mpaas.cronjob.CronJobSetItem
	(*CronJobSet)(nil),           // 6: codehorse.mpaas.cronjob.CronJobSet
	(*pod.Pod)(nil),              // 7: codehorse.mpaas.pod.Pod
	(*meta.Meta)(nil),            // 8: codehorse.mcube.meta.Meta
}
var file_apps_cronjob_pb_cronjob_proto_depIdxs = []int32{
	2, // 0: codehorse.mpaas.cronjob.CreateCronJobRequest.Base:type_name -> codehorse.mpaas.cronjob.CronJobBase
	7, // 1: codehorse.mpaas.cronjob.CreateCronJobRequest.Template:type_name -> codehorse.mpaas.pod.Pod
	3, // 2: codehorse.mpaas.cronjob.CronJobBase.Labels:type_name -> codehorse.mpaas.cronjob.ListMapItem
	1, // 3: codehorse.mpaas.cronjob.CronJobBase.JobBase:type_name -> codehorse.mpaas.cronjob.JobBase
	8, // 4: codehorse.mpaas.cronjob.CronJob.Meta:type_name -> codehorse.mcube.meta.Meta
	0, // 5: codehorse.mpaas.cronjob.CronJob.CronJob:type_name -> codehorse.mpaas.cronjob.CreateCronJobRequest
	5, // 6: codehorse.mpaas.cronjob.CronJobSet.Items:type_name -> codehorse.mpaas.cronjob.CronJobSetItem
