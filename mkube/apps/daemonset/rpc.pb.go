...
var file_apps_daemonset_pb_rpc_proto_rawDesc = []byte{
	...
	0x2e, 0x6d, 0x6b, 0x75, 0x62, 0x65, 0x2e, 0x64, 0x61, 0x65, 0x6d, 0x6f, 0x6e, 0x73, 0x65, 0x74,
	...
	0x65, 0x2e, 0x64, 0x61, 0x65, 0x6d, 0x6f, 0x6e, 0x73, 0x65, 0x74, 0x2e, 0x44, 0x61, 0x65, 0x6d,
	...
	0x6f, 0x72, 0x73, 0x65, 0x2e, 0x6d, 0x6b, 0x75, 0x62, 0x65, 0x2e, 0x64, 0x61, 0x65, 0x6d, 0x6f,
	...
	0x74, 0x12, 0x31, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x68, 0x6f, 0x72, 0x73, 0x65, 0x2e, 0x6d, 0x6b,
	0x75, 0x62, 0x65, 0x2e, 0x64, 0x61, 0x65, 0x6d, 0x6f, 0x6e, 0x73, 0x65, 0x74, 0x2e, 0x55, 0x70,
	...
	0x6b, 0x75, 0x62, 0x65, 0x2e, 0x64, 0x61, 0x65, 0x6d, 0x6f, 0x6e, 0x73, 0x65, 0x74, 0x2e, 0x43,
	...
	0x6c, 0x6f, 0x75, 0x64, 0x2f, 0x6d, 0x6b, 0x75, 0x62, 0x65, 0x2f, 0x61, 0x70, 0x70, 0x73, 0x2f,
...
var file_apps_daemonset_pb_rpc_proto_goTypes = []interface{}{
	(*DeleteDaemonSetRequest)(nil),   // 0: codehorse.mkube.daemonset.DeleteDaemonSetRequest
	(*UpdateDaemonSetRequest)(nil),   // 1: codehorse.mkube.daemonset.UpdateDaemonSetRequest
	(*QueryDaemonSetRequest)(nil),    // 2: codehorse.mkube.daemonset.QueryDaemonSetRequest
	(*DescribeDaemonSetRequest)(nil), // 3: codehorse.mkube.daemonset.DescribeDaemonSetRequest
	(*CreateDaemonSetRequest)(nil),   // 4: codehorse.mkube.daemonset.CreateDaemonSetRequest
	(*DaemonSet)(nil),                // 5: codehorse.mkube.daemonset.DaemonSet
	(*DaemonSetList)(nil),            // 6: codehorse.mkube.daemonset.DaemonSetList
}
var file_apps_daemonset_pb_rpc_proto_depIdxs = []int32{
	4, // 0: codehorse.mkube.daemonset.UpdateDaemonSetRequest.DaemonSet:type_name -> codehorse.mkube.daemonset.CreateDaemonSetRequest
	4, // 1: codehorse.mkube.daemonset.RPC.CreateDaemonSet:input_type -> codehorse.mkube.daemonset.CreateDaemonSetRequest
	0, // 2: codehorse.mkube.daemonset.RPC.DeleteDaemonSet:input_type -> codehorse.mkube.daemonset.DeleteDaemonSetRequest
	1, // 3: codehorse.mkube.daemonset.RPC.UpdateDaemonSet:input_type -> codehorse.mkube.daemonset.UpdateDaemonSetRequest
	2, // 4: codehorse.mkube.daemonset.RPC.QueryDaemonSet:input_type -> codehorse.mkube.daemonset.QueryDaemonSetRequest
	3, // 5: codehorse.mkube.daemonset.RPC.DescribeDaemonSet:input_type -> codehorse.mkube.daemonset.DescribeDaemonSetRequest
	5, // 6: codehorse.mkube.daemonset.RPC.CreateDaemonSet:output_type -> codehorse.mkube.daemonset.DaemonSet
	4, // 7: codehorse.mkube.daemonset.RPC.DeleteDaemonSet:output_type -> codehorse.mkube.daemonset.CreateDaemonSetRequest
	5, // 8: codehorse.mkube.daemonset.RPC.UpdateDaemonSet:output_type -> codehorse.mkube.daemonset.DaemonSet
	6, // 9: codehorse.mkube.daemonset.RPC.QueryDaemonSet:output_type -> codehorse.mkube.daemonset.DaemonSetList
	4, // 10: codehorse.mkube.daemonset.RPC.DescribeDaemonSet:output_type -> codehorse.mkube.daemonset.CreateDaemonSetRequest
