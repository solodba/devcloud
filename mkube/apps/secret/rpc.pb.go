...
var file_apps_secret_pb_rpc_proto_rawDesc = []byte{
	...
	0x2b, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x68, 0x6f, 0x72, 0x73, 0x65, 0x2e, 0x6d, 0x6b, 0x75, 0x62,
	0x65, 0x2e, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53,
	...
	0x65, 0x2e, 0x6d, 0x6b, 0x75, 0x62, 0x65, 0x2e, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x2e, 0x43,
	...
	0x6b, 0x75, 0x62, 0x65, 0x2e, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x2e, 0x53, 0x65, 0x63, 0x72,
	...
	0x6b, 0x75, 0x62, 0x65, 0x2e, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x2e, 0x44, 0x65, 0x6c, 0x65,
	...
	0x65, 0x2e, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x2e, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x53,
	...
	0x6d, 0x6b, 0x75, 0x62, 0x65, 0x2e, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x2e, 0x53, 0x65, 0x63,
	...
	0x6b, 0x75, 0x62, 0x65, 0x2e, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x2e, 0x51, 0x75, 0x65, 0x72,
	...
	0x6d, 0x6b, 0x75, 0x62, 0x65, 0x2e, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x2e, 0x44, 0x65, 0x73,
...
var file_apps_secret_pb_rpc_proto_goTypes = []interface{}{
	(*DeleteSecretRequest)(nil),   // 0: codehorse.mkube.secret.DeleteSecretRequest
	(*UpdateSecretRequest)(nil),   // 1: codehorse.mkube.secret.UpdateSecretRequest
	(*QuerySecretRequest)(nil),    // 2: codehorse.mkube.secret.QuerySecretRequest
	(*DescribeSecretRequest)(nil), // 3: codehorse.mkube.secret.DescribeSecretRequest
	(*CreateSecretRequest)(nil),   // 4: codehorse.mkube.secret.CreateSecretRequest
	(*Secret)(nil),                // 5: codehorse.mkube.secret.Secret
	(*SecretSetItem)(nil),         // 6: codehorse.mkube.secret.SecretSetItem
	(*SecretSet)(nil),             // 7: codehorse.mkube.secret.SecretSet
}
var file_apps_secret_pb_rpc_proto_depIdxs = []int32{
	4, // 0: codehorse.mkube.secret.UpdateSecretRequest.Secret:type_name -> codehorse.mkube.secret.CreateSecretRequest
	4, // 1: codehorse.mkube.secret.RPC.CreateSecret:input_type -> codehorse.mkube.secret.CreateSecretRequest
	0, // 2: codehorse.mkube.secret.RPC.DeleteSecret:input_type -> codehorse.mkube.secret.DeleteSecretRequest
	1, // 3: codehorse.mkube.secret.RPC.UpdateSecret:input_type -> codehorse.mkube.secret.UpdateSecretRequest
	2, // 4: codehorse.mkube.secret.RPC.QuerySecret:input_type -> codehorse.mkube.secret.QuerySecretRequest
	3, // 5: codehorse.mkube.secret.RPC.DescribeSecret:input_type -> codehorse.mkube.secret.DescribeSecretRequest
	5, // 6: codehorse.mkube.secret.RPC.CreateSecret:output_type -> codehorse.mkube.secret.Secret
	6, // 7: codehorse.mkube.secret.RPC.DeleteSecret:output_type -> codehorse.mkube.secret.SecretSetItem
	5, // 8: codehorse.mkube.secret.RPC.UpdateSecret:output_type -> codehorse.mkube.secret.Secret
	7, // 9: codehorse.mkube.secret.RPC.QuerySecret:output_type -> codehorse.mkube.secret.SecretSet
	6, // 10: codehorse.mkube.secret.RPC.DescribeSecret:output_type -> codehorse.mkube.secret.SecretSetItem
