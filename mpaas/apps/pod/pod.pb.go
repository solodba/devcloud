...
type Pod struct {
	...
	Tolerations []*Tolerations `protobuf:"bytes,6,rep,name=Tolerations,proto3" json:"tolerations" bson:"tolerations"`
...
type Volume struct {
	...
	DownwardAPIVolume *DownwardAPIVolume `protobuf:"bytes,6,opt,name=DownwardAPIVolume,proto3" json:"downwardAPIVolume" bson:",inline"`
...
var file_apps_pod_pb_pod_proto_rawDesc = []byte{
	...
	0x64, 0x4c, 0x69, 0x73, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x42, 0x36, 0x5a, 0x34, 0x67, 0x69, 0x74,
	...
	0x69, 0x6e, 0x2f, 0x6d, 0x70, 0x61, 0x61, 0x73, 0x2f, 0x61, 0x70, 0x70, 0x73, 0x2f, 0x70, 0x6f,
...
var file_apps_pod_pb_pod_proto_depIdxs = []int32{
	29, // 0: codehorse.mpaas.pod.CreatePodRequest.Meta:type_name -> codehorse.mcube.meta.Meta
